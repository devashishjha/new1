            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                 <Card>
                    ...
                    <CardContent className="grid md:grid-cols-2 gap-6">
                        <FormField control={form.control} name="priceType" render={({ field }) => ( <FormItem><FormLabel>Listing for</FormLabel><Select onValueChange={field.onChange} value={field.value}><FormControl><SelectTrigger className="text-black"><SelectValue /></SelectTrigger></FormControl><SelectContent><SelectItem value="rent">Rent</SelectItem><SelectItem value="sale">Sale</SelectItem></SelectContent></Select><FormMessage /></FormItem> )} />
                        <FormField control={form.control} name="priceAmount" render={({ field }) => ( <FormItem><FormLabel>Price Amount (₹)</FormLabel><FormControl><Input type="number" placeholder="5000000" {...field} className="text-black" /></FormControl><FormMessage /></FormItem> )} />
                        <FormField control={form.control} name="location" render={({ field }) => ( <FormItem className="md:col-span-2"><FormLabel>Location</FormLabel><FormControl><Textarea placeholder="Full address of the property" {...field} className="text-black" /></FormControl><FormMessage /></FormItem> )} />
                        <FormField control={form.control} name="societyName" render={({ field }) => ( <FormItem className="md:col-span-2"><FormLabel>Society Name</FormLabel><FormControl><Input placeholder="Sunshine Apartments" {...field} className="text-black" /></FormControl><FormMessage /></FormItem> )} />
                    </CardContent>
                </Card>
                ...
                <Accordion type="multiple" className="w-full space-y-4" defaultValue={['item-1']}>
                    <AccordionItem value="item-5" asChild><Card><AccordionTrigger className="p-6"><h3 className="text-2xl font-semibold leading-none tracking-tight">Description & Media</h3></AccordionTrigger><AccordionContent className="p-6 pt-0 grid gap-6">
                        ...
                        <FormField control={form.control} name="video" render={({ field }) => ( <FormItem> <FormLabel>Property Video</FormLabel> <FormControl> <Input type="file" accept="video/*" onChange={(e) => field.onChange(e.target.files)} /> </FormControl> <FormDescription> Upload a short video of your property for the reel. </FormDescription> <FormMessage /> </FormItem> )} />
                    ...
                    <AccordionItem value="item-4" asChild><Card><AccordionTrigger className="p-6"><h3 className="text-2xl font-semibold leading-none tracking-tight">Charges & Fees</h3></AccordionTrigger><AccordionContent className="p-6 pt-0 grid md:grid-cols-2 gap-6">
                        <FormField control={form.control} name="maintenancePerMonth" render={({ field }) => ( <FormItem><FormLabel>Maintenance (/month)</FormLabel><FormControl><Input type="number" placeholder="100" {...field} className="text-black" /></FormControl><FormMessage /></FormItem> )}/>
